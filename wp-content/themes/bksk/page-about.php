...
<?php get_header();
	...
	if(is_page(5112)) {
		...
		echo '<a href="'. get_site_url() .'/sustainability-lab">&larr; Back to Sustain-ability Lab</a>';
	}
	echo '</nav>'; ?>
...
<div class="item rect1 item--half">
	<?php $img = wp_get_attachment_image_src($imgs[1], 'sq500'); ?>
	<img src="<?php echo $img[0]; ?>" />
</div>

<div class="item sq1 twocol">
	<?php $img = wp_get_attachment_image_src($imgs[2], 'sq2'); ?>
	<img src="<?php echo $img[0]; ?>" />
</div>

<div class="item sq1 twocol">
	<?php $img = wp_get_attachment_image_src($imgs[3], 'sq2'); ?>
	<img src="<?php echo $img[0]; ?>" />
</div>
