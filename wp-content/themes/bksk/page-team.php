...
// 			$img = 'http://localhost:8888/wp-content/uploads/2017/01/20160919_Terrell_Place_0005_2_ScreenRes-170x170.jpg';
			...
			echo '<a href="#" data-link="'.$link.'" data-name="'.get_the_title($partners[$i]->ID).'" data-title="'.$title.'" data-credentials="'.$credentials.'" data-bio="'.$bio.'" data-largesrc="'.$img2.'" data-resume="'.$resume['url'].'"><img src="'.$img.'" />';
